...
//          dataset.addValue(8, "triệu đồng", "11/26/2021");  
  ...
  public void bar_chart( java.sql.Date date2, int soNgay){
	...
	Date date1 = calendar.getTime();
           System.out.println("Gui.FrmTongQuanBaoCao.bar_chart()"+date1);
         System.out.println("Gui.FrmTongQuanBaoCao.bar_chart()"+-soNgay);
    ...
    map = hdDao.getTongTienAboutDates(sqlDate1, date2);
      System.out.println("Gui.FrmTongQuanBaoCao.bar_chart()"+sqlDate1);
        System.out.println("Gui.FrmTongQuanBaoCao.bar_chart()"+date2);
//      
//         for (Date d : map.keySet()) {
//             System.out.println("Gui.FrmTongQuanBaoCao.bar_chart()" +d + " n " + map.get(d));
//         }
